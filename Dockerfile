...
RUN apt-get install libusb++-0.1-4c2 libccid pcsd libpcdclite1 pcsc-tools libpcsc-perl libssl libreadline coolkey pcscd pcsc-tools pkg-config libpam-pkcs11 opensc libengine-pkcs11-openssl
